    ...
    <>
      <div className="sm:flex sm:items-center sm:justify-between p-4">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-800">
            Sección que permite agregar contenedores a la empresa
          </p>
        </div>
      ...
      <div className="flex flex-col px-4 lg:px-16">
        ...
        <div className="card border border-gray-200 bg-white p-6 shadow-xl mt-8 rounded-lg sm:w-full">
          <div
            id="secondbox"
            className="overflow-auto md:overflow-visible md:w-full"
          >
                  ...
                  data
                    ...
                    .map((contenedor) => (
                      ...
                      >
                        ...
                        <td
                          className={`px-6 py-4 uppercase whitespace-nowrap text-sm ${
                            contenedor.estado === "disponible"
                              ? "text-green-500"
                              : contenedor.estado === "roto"
                                ? "text-red"
                                : contenedor.estado === "ocupado"
                                  ? "text-graydark"
                                  : null
                          }`}
                        >
