...
const Dashboards: React.FC = () => {
  ...
  return (
    <>
      <div className="flex rounded-sm border border-stroke py-2 mb-4">
        <ExportExcel />
      </div>
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
        {/* rate="0.43%" levelUp se pueden agregar */}
        <CardDataStats
          title="Cantidad contenedores"
          total={contenedores.length.toString()}
          rate=""
        >
          <Image src="/dumpster.png" width="22" height="22" alt="dumpster" />
        </CardDataStats>
        <CardDataStats
          title="Cantidad de pedidos entregados (en sitio)"
          total={pedidosEntregados.length.toString()}
          rate=""
        >
          <svg
        ...
        <CardDataStats
          title="Cantidad de pedidos pendientes de entrega"
          total={pedidosPendientes.length.toString()}
          rate=""
        >
          <svg
        ...
        <CardDataStats
          title="Choferes actuales"
          total={choferes.length.toString()}
          rate=""
        >
          <svg
