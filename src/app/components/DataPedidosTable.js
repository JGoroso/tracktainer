      ...
      <div className="w-full">
        <div className="bg-white py-4 md:py-7 px-4 md:px-8 overflow-x-auto">
          <div className="flex flex-col sm:items-center sm:gap-4 sm:flex-row">
            ...
            >
              <div
                className={`py-2 sm:px-8 ${filtro === "Todos" ? "bg-indigo-100" : ""} text-indigo-700 rounded-full text-center`}
              >
                <p>Todos</p>
              </div>
            </a>
            <a
              ...
              className="cursor-pointer rounded-full focus:outline-none focus:ring-2 focus:ring-yellow-200"
            >
            ...
            <a
              ...
              className="cursor-pointer rounded-full focus:outline-none focus:ring-2 focus:ring-green-800"
            >
            ...
            <a
              onClick={() => setFiltro("retirar")}
              className="cursor-pointer rounded-full focus:outline-none focus:ring-2 focus:ring-orange-800"
            >
            ...
            <table className="min-w-full table-auto">
              <thead className="bg-gray-100 font-bold uppercase bg-gray-2 rounded-sm ">
                <tr>
                  ...
                  <th
                    scope="col"
                    className="px-4 py-3.5 text-sm font-medium text-left text-gray-500"
                  >
                    ¿Quién recibe?
                  </th>
                  <th
                    ...
                    .map((pedido) => (
                      ...
                      >
                        <td className="px-2 py-4 whitespace-nowrap">
                          <p
                            className={`text-base font-medium text-left uppercase
                        ${
                        ...
                        <td className="px-2 py-4 whitespace-nowrap relative">
                          <button
                            ...
                            onClick={() =>
                              setOpenDropdown(
                                openDropdown === pedido.id ? null : pedido.id
                              )
                            }
                          >
                            <EllipsisVerticalIcon
                          ...
                          {openDropdown === pedido.id && (
                            <div
                              className="absolute right-0 z-10 w-50 mt-2 bg-white border border-gray-200 rounded-md shadow-lg"
                              ref={dropdownRef}
                            >
                              <button
