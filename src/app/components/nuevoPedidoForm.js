...
function NuevoPedidoForm() {
  ...
  // este hook nos devuelve algunas cosillas
  // register: registra nuevos input fields
  // handlesubmit: maneja el envio
  const { register, handleSubmit, setValue, errors, watch } = useForm({ defautlValues: {} })

  useEffect(() => {

    register({ name: "direccion" }, { required: "Por favor, ingrese una direccion" })
  ...
  return (
    <form className="m-40" onSubmit={handleSubmit(onSubmit)}>
      <h1 className="mb-20 text-5xl font-extrabold text-black">Agregar Pedido<small className="ml-2 text-sm font-semibold text-gray-500 dark:text-gray-400">En esta seccion podras agregar un pedido</small></h1>
      <div className="relative z-0 w-full mb-6 group">
        {/* <Searchbox onSelectAddress="" /> */}
